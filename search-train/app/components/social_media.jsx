...
class SocialMedia extends React.Component{
	...
	componentDidMount(){
		...
		const ROOT_URL = `http://api.openweathermap.org/data/2.5/weather?id=4560349&units=imperial&appid=${API_KEY}`;
	...
	render(){
		...
		var status;
		status = "http://openweathermap.org/img/w/" + this.state.weather.weather[0].icon + ".png";
		...
		return(
			...
			<h5>Copyright SEPTA &nbsp;<img src ="../images/favicon.ico"/>&nbsp; All rights Reserved</h5>	
			</div>
			)
	}
}
