...
class BTHeader2 extends React.Component{
	...
	render(){
		...
		return(
		    ...
		    <li ><Link to={`/bus_trolley/${firstLocation}/15B`}>15B</Link></li>
		    ...
		    <li ><Link to={`/bus_trolley/${firstLocation}/36B`}>36B</Link></li>
		    </ul>
		    </li>
		    ...
		    <li ><Link to={`/bus_trolley/${firstLocation}/311`}>311</Link></li>
