...
//Advisory Class is used to get the advisory of the specific train
	...
	render(){
		...
		*/
		...
		return(
			...
			<img src={advisoryTopIcon} alt="advisory" /><strong> Advisory for Line # {this.props.train.line}</strong>
			</h4>
