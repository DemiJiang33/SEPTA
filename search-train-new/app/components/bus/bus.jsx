...
class Bus extends React.Component{
	...
	tick(){
		...
		//var url = "https://apitest.septa.org/api/TransitViewAll/?routes=" + route +"," + route2 +"," + route3;

		//new API
		var url = "https://www3.septa.org/api/TransitViewAll/?routes=" + route +"," + route2 +"," + route3;
