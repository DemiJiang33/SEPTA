	...
	render(){
		...
		return(
			...
			{this.state.ntaResults.map(function(ntaResult,i){
				return(
					<NTAResult ntaResult={ntaResult} key={i} length={length} id={i+1} dStation={dStation}/>
					)
			})}
			</div>
			</div>
